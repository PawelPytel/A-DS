...
test_macierz.set_connection(0,3)
test_macierz.set_connection(1,2)
test_macierz.set_connection(1,4)
test_macierz.set_connection(4,2)
test_macierz.set_connection(4,7)
test_macierz.set_connection(6,5)
test_macierz.set_connection(6,3)
test_macierz.set_connection(1,3)
test_macierz.set_connection(3,4)
test_macierz.set_connection(5,3)
